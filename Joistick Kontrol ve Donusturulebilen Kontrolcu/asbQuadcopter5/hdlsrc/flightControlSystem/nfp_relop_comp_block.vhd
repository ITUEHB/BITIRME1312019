...
-- -------------------------------------------------------------
-- 
-- Module: nfp_relop_comp_block
-- Source Path: flightController/Flight Controller/Attitude/nfp_relop_comp
-- Hierarchy Level: 3
-- 
...
ENTITY nfp_relop_comp_block IS
  PORT( nfp_in1                           :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
        nfp_in2                           :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
        nfp_out1                          :   OUT   std_logic  -- ufix1
        );
END nfp_relop_comp_block;


ARCHITECTURE rtl OF nfp_relop_comp_block IS
